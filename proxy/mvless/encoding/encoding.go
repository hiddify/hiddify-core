...
func EncodeRequestHeader(writer io.Writer, request *protocol.RequestHeader, requestAddons *Addons) error {
	...
	if _, err := buffer.Write(request.User.Account.(*mvless.MemoryAccount).ID.Bytes()); err != nil {
...
func DecodeRequestHeader(isfb bool, first *buf.Buffer, reader io.Reader, validator mvless.Validator) (*protocol.RequestHeader, *Addons, bool, error) {
	buffer := buf.StackNew()
	defer buffer.Release()
